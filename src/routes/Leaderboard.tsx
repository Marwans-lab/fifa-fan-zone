      ...
      <div className="f-page-enter scroll-y" style={{ display: 'flex', flexDirection: 'column', padding: 'var(--f-brand-space-lg) var(--f-brand-space-md) 100px', width: '100%', maxWidth: 420, margin: '0 auto' }}>
        ...
        {myRank !== null && (
          <div style={{
            ...
            {myRank <= 5 && (
              <span style={{ font: 'var(--f-brand-type-caption)', fontSize: '13', color: 'var(--f-brand-color-accent)', marginLeft: 8, display: 'inline-flex', alignItems: 'center', gap: 4 }}>
          ...
          {entries.map(row => (
            ...
            >
              ...
              <div style={{ flex: 1, font: 'var(--f-brand-type-body)', fontSize: '15', color: 'var(--f-brand-color-text-default)', fontWeight: row.isMe ? '500' : '400' }}>
                {row.name}
                {row.isMe && <span style={{ font: 'var(--f-brand-type-caption)', fontSize: '11', color: 'var(--f-brand-color-accent)', marginLeft: 8, letterSpacing: '0.05em' }}>you</span>}
              </div>
              {[
