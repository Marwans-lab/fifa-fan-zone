...
@Component({
  selector: 'app-swipe-quiz-page',
  standalone: true,
  template: `
    <main class="page-in" data-route="swipe-quiz" style="min-height: 100dvh; padding: var(--sp-6);">
      <h1 style="font: var(--f-brand-type-title-3); color: var(--c-text-1);">Swipe quiz</h1>
