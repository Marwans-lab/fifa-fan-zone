...
@Component({
  selector: 'app-ranking-quiz-page',
  standalone: true,
  template: `
    <main class="page-in" data-route="ranking-quiz" style="min-height: 100dvh; padding: var(--sp-6);">
      <h1 style="font: var(--f-brand-type-title-3); color: var(--c-text-1);">Ranking quiz</h1>
